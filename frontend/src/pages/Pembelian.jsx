...
export default function Pembelian() {
    ...
    useEffect(()=> {
        ...
        fetch("https://backend-production-5484.up.railway.app/pembelian")
            .then((res) => res.json())
    ...
    const handleSubmit = async (e) => {
        ...
        if (file == null) 
        {
            try {
                console.log(data);
                await fetch("https://backend-production-5484.up.railway.app/pembelian/", {
                    method: "POST",
                    headers: {
            ...
            try {
                ...
                await fetch("https://backend-production-5484.up.railway.app/pembelian/upload", {
                    method: "POST",
                    body: formData,
                });
                window.location.reload(true);
    ...
    return (
        <Navbar>
            ...
            <div className="flex flex-col justify-between bg-white rounded-lg my-4 px-2 shadow-lg">
                <p className="text-2xl m-4">Input data Transaksi Pembelian</p>
